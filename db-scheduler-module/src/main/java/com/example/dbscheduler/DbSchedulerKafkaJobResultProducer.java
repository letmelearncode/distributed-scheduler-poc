...
@Service("dbSchedulerKafkaJobResultProducer")
@Profile("db-scheduler")
public class DbSchedulerKafkaJobResultProducer {

    private static final Logger log = LoggerFactory.getLogger(DbSchedulerKafkaJobResultProducer.class);

    @Autowired
    @Qualifier("dbSchedulerKafkaTemplate")
